...
<CodeSwitcher displayMode="tabs">
  <CodeBlock language="txt" source="../code-samples/data-type/direct-request/locations_syntax.txt" group="syntax"/>
  <CodeBlock language="txt" source="../code-samples/data-type/direct-request/locations_example.txt" group="example"/>
</CodeSwitcher>
...
You must specify the JSON object containing the settings for a travel mode supported by your organization. For a list of supported travel modes, run the [`GetTravelModes`](/gettravelmodes-tool) service from the Utilities service.

</If>

<If c="publication=='rest/online'">

You must specify the JSON object containing the settings for a travel mode supported by your organization. For a list of supported travel modes, run the [`GetTravelModes`](/gettravelmodes-synchronous-task) service from the Utilities service.
...
<CodeBlock language="json" source="../code-samples/data-type/job-request/travel_mode_gtm_response.json" group="json" maxLines={20} expandable/>
