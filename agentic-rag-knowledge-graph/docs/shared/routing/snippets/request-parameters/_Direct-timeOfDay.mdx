...
<CodeSwitcher>
  <CodeBlock language="json" source="../../code-samples/shared/examples/input/direct_timeOfDay_ex1.json" group="json" maxLines={20} expandable/>
</CodeSwitcher>
...
<CodeSwitcher>
  <CodeBlock language="json" source="../../code-samples/shared/examples/input/direct_timeOfDay_ex2.json" group="json" maxLines={20} expandable/>
</CodeSwitcher>
...
<CodeSwitcher>
  <CodeBlock language="json" source="../../code-samples/shared/examples/input/direct_timeOfDay_ex3.json" group="json" maxLines={20} expandable/>
</CodeSwitcher>
...
<CodeSwitcher>
  <CodeBlock language="json" source="../../code-samples/shared/examples/input/direct_timeOfDay_ex4.json" group="json" maxLines={20} expandable/>
</CodeSwitcher>
