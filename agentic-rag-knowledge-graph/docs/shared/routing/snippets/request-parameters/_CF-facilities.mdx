...
-   <p class="space-x-2"><span class="font-bold">Attr_[Cost]</span><span class="font-sm text-color-3">number (non-negative)</span><span class="font-bold text-[#6d29cc]">default:0</span><span class="font-bold text-[#00619b]">nullable</span></p>
    ...
    <Note>
    Multiple `Attr_[Cost]` attributes can be included for the facilities. The attribute values are only referenced if the cost attribute referred to in the attribute name is used in the analysis, as [impedanceAttributeName](#impedanceattributename) or [accumulateAttributeNames](#accumulateattributenames).
    </Note>
...
-   <p class="space-x-2"><span class="font-bold">Cutoff_[Impedance]</span><span class="font-sm text-color-3">number (non-negative)</span><span class="font-bold text-[#6d29cc]">default:null</span></p>
    ...
    <Note>
    Multiple `Cutoff_[Impedance]` attributes can be included for the facilities. Consequently, you may have more than one time-based or distance-based `Cutoff_[Impedance]` field. The attribute values are only referenced if the cost attribute referred to in the attribute name is used in the analysis, as [impedanceAttributeName](#impedanceattributename) or [accumulateAttributeNames](#accumulateattributenames).
    </Note>
...
<CodeBlock language="json" source="../../code-samples/closestFacility/examples/inputs/facilities_ex.json" group="json" maxLines={20} expandable/>
</If>