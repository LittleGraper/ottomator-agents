{/*Shared snippet for Last mile delivery service */} 

import Context from "../snippets/request-parameters/_Context.mdx"
import DirectionsLanguage from "../snippets/request-parameters/_DirectionsLanguage-JDR-OnE.mdx"
import DistanceUnits from "../snippets/request-parameters/_DistanceUnits.mdx"
import ResponseFormat from "../snippets/request-parameters/_ResponseFormat.mdx"
import IgnoreInvalidOrderLocations from "../snippets/request-parameters/_IgnoreInvalidOrderLocations-LMD.mdx"
import LineBarriers from "../snippets/request-parameters/_LineBarriers.mdx"
import LocateSettings from "../snippets/request-parameters/_LocateSettings.mdx"
import OutputFormat from "../snippets/request-parameters/_OutputFormat-JR-OnE.mdx"
import PointBarriers from "../snippets/request-parameters/_PointBarriers.mdx"
import PolygonBarriers from "../snippets/request-parameters/_PolygonBarriers.mdx"
import PopulateDirections from "../snippets/request-parameters/_PopulateDirections-LMD.mdx"
import SaveOutputNALayer from "../snippets/request-parameters/_SaveOutputNALayer-JR-OnE.mdx"
import SaveRouteData from "../snippets/request-parameters/_SaveRouteData-JR-OnE.mdx"
import TimeUnits from "../snippets/request-parameters/_TimeUnits.mdx"
import Tokens from "../snippets/request-parameters/_Token.mdx"
import TravelModes from "../snippets/request-parameters/_TravelMode.mdx"
import AnalysisRegion from "../snippets/request-parameters/_AnalysisRegion-JR-OnE.mdx"

import ParamMetadata from "../../components/param-metatdata" 

import SharedContent from "../../content/_required-params.mdx"

<CodeSwitcher>
<CodeBlock language="curl" label="GET">{`GET  https://logistics.arcgis.com/arcgis/rest/services/World/VehicleRoutingProblem/GPServer/SolveLastMileDelivery/submitJob`}</CodeBlock>
<CodeBlock language="curl" label="POST">{`POST https://logistics.arcgis.com/arcgis/rest/services/World/VehicleRoutingProblem/GPServer/SolveLastMileDelivery/submitJob`}</CodeBlock>
</CodeSwitcher>

The `/SolveLastMileDelivery` [job request](/service-requests/#job-requests) service is a use case specific Vehicle Routing Problem (VRP) algorithm designed for a fleet of vehicles that are delivering packages to the final customers. For example, this can be used for a single distribution center or store delivering to the final customer location and can be quite dense delivering to a few customers on most streets but is not intended to visit every house on every street.
...
<Note type={"note"}>
Minimum requirements for Last Mile Delivery service are one order and one route. Each order and route needs a unique name. The earliest start time, the earliest start date, and the maximum total time are required for each route and can be specified using the `EarliestStartTime`, `EarliestStartDate`, and `MaxTotalTime` attributes on the `routes` parameter. These three values can alternatively be specified as [`earliest_route_start_date`](#earliest_route_start_date), [`earliest_route_start_time`](#earliest_route_start_time), and [`max_route_total_time`](#max_route_total_time) parameters.
</Note>

{/* (Need to remove this as the service is moving out of Beta in the Feb 2025 release)
<If c="publication=='rest/online'">
<Note type={"note"}>
The Last Mile Delivery service will not charge any credits during the beta period.
</Note>
</If> */}
...
<StyledTable headers="Name, Required, Type, Default, Description">
  ...
  <StyledTableRow>
   ...
   One or more locations that the routes of the last mile delivery analysis will visit. 
  ...
  <StyledTableRow>
    <StyledTableCell cellStyle="code">[order_specialties](#order_specialties)</StyledTableCell>
   ...
   Specialties that can be required by orders and supported by routes.

    </StyledTableCell>
  </StyledTableRow>
  <StyledTableRow>
    <StyledTableCell cellStyle="code">[route_specialties](#route_specialties)</StyledTableCell>
    <StyledTableCell cellStyle="check" checked={false}></StyledTableCell>
    <StyledTableCell cellStyle="code_italic">feature</StyledTableCell>
    <StyledTableCell cellStyle="markdown">
    </StyledTableCell>
  ...
  <StyledTableRow>
    <StyledTableCell cellStyle="code">[zones](#zones)</StyledTableCell>
    <StyledTableCell cellStyle="check" checked={false}></StyledTableCell>
    <StyledTableCell cellStyle="code_italic">feature</StyledTableCell>
    <StyledTableCell cellStyle="markdown">
    </StyledTableCell>
  ...
  <StyledTableRow>
    <StyledTableCell cellStyle="code">[ignore_invalid_order_locations](#ignore_invalid_order_locations)</StyledTableCell>
    <StyledTableCell cellStyle="check" checked={false}></StyledTableCell>
    ...
    <StyledTableCell cellStyle="markdown">
      Ignores invalid order locations.
    </StyledTableCell>
  </StyledTableRow>
  <StyledTableRow>
    <StyledTableCell cellStyle="code">[earliest_route_start_date](#earliest_route_start_date)</StyledTableCell>
    <StyledTableCell cellStyle="check" checked={false}></StyledTableCell>
    <StyledTableCell cellStyle="code_italic">string</StyledTableCell>
    <StyledTableCell cellStyle="markdown">
    </StyledTableCell>
    <StyledTableCell cellStyle="markdown">
      Default earliest start date for routes
    </StyledTableCell>
  </StyledTableRow>
  <StyledTableRow>
    <StyledTableCell cellStyle="code">[earliest_route_start_time](#earliest_route_start_time)</StyledTableCell>
    <StyledTableCell cellStyle="check" checked={false}></StyledTableCell>
    <StyledTableCell cellStyle="code_italic">string</StyledTableCell>
    <StyledTableCell cellStyle="markdown">
    </StyledTableCell>
    <StyledTableCell cellStyle="markdown">
      Default earliest start time for routes.
    </StyledTableCell>
  </StyledTableRow>
  <StyledTableRow>
  ...
  <StyledTableRow>
    <StyledTableCell cellStyle="code">[max_route_total_time](#max_route_total_time)</StyledTableCell>
    <StyledTableCell cellStyle="check" checked={false}></StyledTableCell>
    <StyledTableCell cellStyle="code_italic">number</StyledTableCell>
    <StyledTableCell cellStyle="markdown">
    </StyledTableCell>
    <StyledTableCell cellStyle="markdown">
      The maximum allowed total time for each route. 
    </StyledTableCell>
  </StyledTableRow>
  <StyledTableRow>
    <StyledTableCell cellStyle="code">[sequence_gap](#sequence_gap)</StyledTableCell>
    <StyledTableCell cellStyle="check" checked={false}></StyledTableCell>
    ...
    <StyledTableCell cellStyle="markdown">
      Gap in numerical values to leave in the `Sequence` attribute in the `orders` parameter between adjacent orders when the analysis is solved. 
    </StyledTableCell>
  </StyledTableRow>
  <StyledTableRow>
  ...
  <StyledTableRow>
    ...
    <StyledTableCell cellStyle="markdown">
      Type of route features that are output by the service.
    </StyledTableCell>
  </StyledTableRow>
  <StyledTableRow>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/inputs/orders.json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/inputs/depots.json" group="json" maxLines={20} expandable/>
...
<ParamMetadata required types={[{name:"Table",link:"../routing-data-types#table"}]} />
...
<CodeBlock language="json" source="../code-samples/lmd/examples/inputs/routes.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/inputs/order_specialties.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/inputs/route_specialties.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/inputs/zones.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/outputs/output_orders.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/outputs/output_routes.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/outputs/output_depots.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/outputs/output_depot_visits.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/outputs/output_directions_points.json" group="json" maxLines={20} expandable/>
...
<CodeBlock language="json" source="../code-samples/lmd/examples/outputs/output_directions_lines.json" group="json" maxLines={20} expandable/>
...
The section below has various examples to work with the last mile delivery service.
...
<TabNav slot="tab-nav">
  ...
  <TabTitle>4. Get one result (output_routes)</TabTitle>
</TabNav>
...
<If c="publication=='services-reference/enterprise'">
<CodeSwitcher>
  <CodeBlock language="http" source="../code-samples/lmd/submit_job.http" group="HTTP" maxLines={20} expandable/>
</CodeSwitcher>
</If>

<If c="publication=='rest/online'">
<CodeSwitcher>
  <CodeBlock language="http" source="../code-samples/lmd/submit_job_online.http" group="HTTP" maxLines={20} expandable/>
</CodeSwitcher>
</If>

**Response (JSON)**

<CodeBlock language="json" source="../code-samples/lmd/submit_job_response.json" maxLines={20} expandable/>
...
<If c="publication=='services-reference/enterprise'">
<CodeSwitcher>
  <CodeBlock language="http" source="../code-samples/lmd/get_job_status.http" group="HTTP" maxLines={10} expandable/>
</CodeSwitcher>
</If>

<If c="publication=='rest/online'">
<CodeSwitcher>
  <CodeBlock language="http" source="../code-samples/lmd/get_job_status_online.http" group="HTTP" maxLines={10} expandable/>
</CodeSwitcher>
</If>
...
<CodeSwitcher displayMode="tabs">
    <CodeBlock language="json" source="../code-samples/lmd/job_status_executing_response.json" group="Job Executing" maxLines={20} expandable/>
    <CodeBlock language="json" source="../code-samples/lmd/job_status_failed_response.json" group="Job Failed" maxLines={20} expandable/>
    <CodeBlock language="json" source="../code-samples/lmd/job_status_succeeded_response.json" group="Job Succeeded" maxLines={20} expandable/>
    <CodeBlock language="json" source="../code-samples/lmd/job_status_succeeded_partial_response.json" group="Job Succeeded Partial Solution" maxLines={20} expandable/>
</CodeSwitcher>
...
<If c="publication=='services-reference/enterprise'">
<CodeSwitcher>
  <CodeBlock language="http" source="../code-samples/lmd/get_results.http" group="HTTP" maxLines={10} expandable/>
</CodeSwitcher>
</If>

<If c="publication=='rest/online'">
<CodeSwitcher>
  <CodeBlock language="http" source="../code-samples/lmd/get_results_online.http" group="HTTP" maxLines={10} expandable/>
</CodeSwitcher>
</If>

**Response (JSON)**

<CodeBlock language="json" source="../code-samples/lmd/result_full.json" maxLines={20} expandable/>
...
<If c="publication=='services-reference/enterprise'">
<CodeSwitcher>
  <CodeBlock language="http" source="../code-samples/lmd/get_result_route.http" group="HTTP" maxLines={10} expandable/>
</CodeSwitcher>
</If>

<If c="publication=='rest/online'">
<CodeSwitcher>
  <CodeBlock language="http" source="../code-samples/lmd/get_result_route_online.http" group="HTTP" maxLines={10} expandable/>
</CodeSwitcher>
</If>
...
{/* <CodeSwitcher>
  <CodeBlock
      language="js"
      source="../code-samples/fleet-examples/job/ex1-response-3b-abbv.json"
      group="Abbreviated Response"
      highlightLines="15, 17, 27, 37, 47, 67, 69, 78, 80"
      links={[{ url: "examples/routing-and-directions/fleet-job/ex1-response-3b-full.json", label: "See full response"}]}
      expandable />
</CodeSwitcher> */}

<CodeSwitcher>
  <CodeBlock language="json" source="../code-samples/lmd/result_output_routes.json" group="HTTP" maxLines={20} expandable/>
</CodeSwitcher>
