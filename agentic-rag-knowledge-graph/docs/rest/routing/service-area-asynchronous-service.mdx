...
uid: "service-area-job"
slug: "service-area-asynchronous-service"
url: "/routing/service-area-asynchronous-service"
guid: "GUID-EFCEDD90-FB38-4CD4-9E2B-75F502716C3F"
migratedTopicMetadata:
  FTITLE: "Service Area Asynchronous Service"
  FDESCRIPTION: ""
...
"
  ...
  CREATED-ON: "28/03/2023 11:43:12"
  FAUTHOR: "pchopra"
  FSTATUS: "Released"
  MODIFIED-ON: "17/04/2023 11:28:11"
  VERSION: "23"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "2"
  ED: "GUID-939232F5-ECA1-49DD-B35A-413AA035AEFD"
...
To learn more about the direct request, see [Direct request](/service-area-synchronous-service) documentation.

You can make a job request to the Service area service using the following form:
...
[facilities](/service-area-asynchronous-service#facilities)
...
-   [As a collection of features](/service-area-asynchronous-service#syntax-examples-for-facilities)
-   [As a feature service URL](/service-area-asynchronous-service#syntax-examples-for-facilities)
...
[token](/service-area-asynchronous-service#token)
...
[f](/service-area-asynchronous-service#f)
...
[travel_mode](/service-area-asynchronous-service#travel_mode)
...
[break_values](/service-area-asynchronous-service#break_values)
...
[break_units](/service-area-asynchronous-service#break_units)
...
[travel_direction](/service-area-asynchronous-service#travel_direction)
...
[time_of_day](/service-area-asynchronous-service#time_of_day)
...
[time_zone_for_time_of_day](/service-area-asynchronous-service#time_zone_for_time_of_day)
...
[use_hierarchy](/service-area-asynchronous-service#use_hierarchy)
...
[uturn_at_junctions](/service-area-asynchronous-service#uturn_at_junctions)
...
[polygons_for_multiple_facilities](/service-area-asynchronous-service#polygons_for_multiple_facilities)
...
[polygon_overlap_type](/service-area-asynchronous-service#polygon_overlap_type)
...
[detailed_polygons](/service-area-asynchronous-service#detailed_polygons)
...
[polygon_trim_distance](/service-area-asynchronous-service#polygon_trim_distance)
...
[polygon_simplification_tolerance](/service-area-asynchronous-service#polygon_simplification_tolerance)
...
[point_barriers](/service-area-asynchronous-service#point_barriers)
...
-   [As a collection of features](/service-area-asynchronous-service#syntax-examples-for-point_barriers)
-   [As a feature service URL](/service-area-asynchronous-service#syntax-examples-for-point_barriers)
...
[line_barriers](/service-area-asynchronous-service#line_barriers)
...
-   [As a collection of features](/service-area-asynchronous-service#syntax-examples-for-line_barriers)
-   [As a feature service URL](/service-area-asynchronous-service#syntax-examples-for-line_barriers)
...
[polygon_barriers](/service-area-asynchronous-service#polygon_barriers)
...
-   [As a collection of features](/service-area-asynchronous-service#syntax-examples-for-polygon_barriers)
-   [As a feature service URL](/service-area-asynchronous-service#syntax-examples-for-polygon_barriers)
...
[restrictions](/service-area-asynchronous-service#restrictions)
...
[See the list](/service-area-asynchronous-service#restrictions) for acceptable values.
...
[attribute_parameter_values](/service-area-asynchronous-service#attribute_parameter_values)
...
[See the list](/service-area-asynchronous-service#attribute_parameter_values) for acceptable values.
...
[impedance](/service-area-asynchronous-service#impedance)
...
[analysis_region](/service-area-asynchronous-service#analysis_region)
...
[See the list](/service-area-asynchronous-service#analysis_region) for acceptable values.
...
[save_output_network_analysis_layer](/service-area-asynchronous-service#save_output_network_analysis_layer)
...
[overrides](/service-area-asynchronous-service#overrides)
...
[time_impedance](/service-area-asynchronous-service#time_impedance)
...
[distance_impedance](/service-area-asynchronous-service#distance_impedance)
...
[polygon_detail](/service-area-asynchronous-service#polygon_detail)
...
[output_type](/service-area-asynchronous-service#output_type)
...
[output_format](/service-area-asynchronous-service#output_format)
...
[env:outSR](/service-area-asynchronous-service#envoutsr)
...
[ignore_invalid_locations](/service-area-asynchronous-service#ignore_invalid_locations)
...
[locate_settings](/service-area-asynchronous-service#locate_settings)
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/GenerateServiceAreas/jobs/<yourJobID>?token=<yourToken>&returnMessages=true&f=json` 
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/GenerateServiceAreas/jobs/<yourJobID>/cancel?token=<yourToken>&f=json` 
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/GenerateServiceAreas/jobs/<yourJobID>/results/<output_parameter_name>?token=<yourToken>&f=json` 

Instead of retrieving outputs individually, you can make a request of the following form to retrieve all the outputs.

`https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/GenerateServiceAreas/jobs/<yourJobID>/results?token=<yourToken>&f=json` 

Refer to the [Output parameters](/service-area-asynchronous-service#output-parameters) section for more information on how to interpret the solution provided by the service.
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/GenerateServiceAreas/jobs/<yourJobID>/results/<output_parameter_name>?token=<yourToken>&f=json&outSR=102100` 
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/GenerateServiceAreas/jobs/<yourJobID>/results?token=<yourToken>&f=json&outSR=102100` 

The below example shows how to retrieve the value for an input parameter by making the requests of the following form:

`https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/GenerateServiceAreas/jobs/<yourJobID>/inputs/<inputParameterName>?token=<yourToken>&f=json` 

The below example shows how to retrieve all the inputs by making the request of the following form.

`https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/GenerateServiceAreas/jobs/<yourJobID>/inputs?token=<yourToken>&f=json` 

## Output parameters

Upon successful execution, the service returns the service areas around the facilities and the status indicating the analysis was successful by using the `service_areas` , `output_facilities` , and `solve_succeeded`  output parameters. 
...
Multiple facilities can be associated with one service area when the `polygons_for_multiple_facilities`  property is set to `Merge by Break Value` ; therefore, `FacilityOID`  field values are set to null when service areas are merged.
...
Multiple facilities can be associated with one service area when the `polygons_for_multiple_facilities`  property is set to `Merge by Break Value` ; therefore, `FacilityID`  field values are set to null when service areas are merged.
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/
GenerateServiceAreas/submitJob?facilities={"features":[{"geometry":{"x":-122.253,"y":37.757},
"attributes":{"Name":"Store5689"}}]}&env:outSr=102100&f=json&token=<yourToken>
```

```javascript
https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/
GenerateServiceAreas/submitJob?facilities=%7B%22features%22:%5B%7B%22geometry%22:%7B%22x%22:-122.253,%22y%22:37.757%7D,
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/
GenerateServiceAreas/jobs/<yourJobID>?f=json&token=<yourToken>
```
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/ServiceAreas/GPServer/
GenerateServiceAreas/jobs/<yourJobID>/results/service_areas?f=pjson&token=<yourToken>
```
