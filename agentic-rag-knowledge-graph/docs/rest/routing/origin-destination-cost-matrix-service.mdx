...
uid: "origin-destination-cost-matrix-job"
slug: "origin-destination-cost-matrix-service"
url: "/routing/origin-destination-cost-matrix-service"
guid: "GUID-3ABE4D35-4CDB-4C03-9348-C794058D699B"
migratedTopicMetadata:
  FTITLE: "Origin Destination Cost Matrix service"
  FDESCRIPTION: "REST API for Origin Destination Cost Matrix service with asynchronous execution"
  ...
  CREATED-ON: "26/07/2023 16:25:24"
  FAUTHOR: "pchopra"
  FSTATUS: "Released"
  MODIFIED-ON: "09/08/2023 15:50:37"
  VERSION: "22"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "3"
  ED: "GUID-1D9D1D6B-BEBF-4A41-B5C4-7A312BE42B68"
...
To learn more about the direct request, see [Direct request](/origin-destination-cost-matrix-synchronous-service) documentation.
...
Values: [see list](/origin-destination-cost-matrix-service#analysis_region)
...
[save_output_network_analysis_layer](/origin-destination-cost-matrix-service#save_output_network_analysis_layer)
...
Refer to the [Output parameters](/origin-destination-cost-matrix-service#output-parameters) section for more information on how to interpret the solution provided by the service.
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/OriginDestinationCostMatrix/GPServer/GenerateOriginDestinationCostMatrix/submitJob?
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/OriginDestinationCostMatrix/GPServer/GenerateOriginDestinationCostMatrix/jobs/<jobID>?
...
```javascript
https://logistics.arcgis.com/arcgis/rest/services/World/OriginDestinationCostMatrix/GPServer/GenerateOriginDestinationCostMatrix/jobs/
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/OriginDestinationCostMatrix/GPServer/GenerateOriginDestinationCostMatrix/jobs/<jobID>/results/
output_origins?f=pjson&token=<yourToken>
...
```javascript
https://logistics.arcgis.com/arcgis/rest/services/World/OriginDestinationCostMatrix/GPServer/GenerateOriginDestinationCostMatrix/jobs/<jobID>/
results/output_origins?f=pjson&token=<yourToken>
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/OriginDestinationCostMatrix/GPServer/GenerateOriginDestinationCostMatrix/jobs/
<jobID>/results/output_destinations?f=pjson&token=<yourToken>
```
