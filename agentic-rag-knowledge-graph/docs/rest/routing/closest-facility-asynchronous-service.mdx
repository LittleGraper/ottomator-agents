...
uid: "closest-facility-job"
slug: "closest-facility-asynchronous-service"
url: "/routing/closest-facility-asynchronous-service"
guid: "GUID-59A7B36C-592D-4F73-8899-3032815E09B5"
migratedTopicMetadata:
  FTITLE: "Closest Facility Asynchronous Service"
  FDESCRIPTION: "REST API help for the Closest Facility geoprocessing service."
...
"
  ...
  CREATED-ON: "28/03/2023 11:11:25"
  FAUTHOR: "pchopra"
  FSTATUS: "Released"
  MODIFIED-ON: "17/04/2023 11:28:05"
  VERSION: "20"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "3"
  ED: "GUID-54713C85-B7C9-48DC-988C-68CCC32AD2B4"
...
To learn more about the direct request, see [Direct request](/closest-facility-synchronous-service) documentation.

You can make a job request to the Closest facility service using the following form:
...
The closest facility request takes the following parameters. You must always include values for the required parameters in your requests. The optional parameters have default values that are used when not specified in the request.
...
[incidents](/closest-facility-asynchronous-service#incidents)
...
-   [As a collection of features](/closest-facility-asynchronous-service#syntax-examples-for-incidents)
-   [As a feature service URL](/closest-facility-asynchronous-service#syntax-examples-for-incidents)
...
[facilities](/closest-facility-asynchronous-service#facilities)
...
-   [As a collection of features](/closest-facility-asynchronous-service#syntax-examples-for-facilities)
-   [As a feature service URL](/closest-facility-asynchronous-service#syntax-examples-for-facilities)
...
[token](/closest-facility-asynchronous-service#token)
...
[f](/closest-facility-asynchronous-service#f)
...
[travel_mode](/closest-facility-asynchronous-service#travel_mode)
...
[measurement_units](/closest-facility-asynchronous-service#measurement_units)
...
[analysis_region](/closest-facility-asynchronous-service#analysis_region)
...
Values: [See list](/closest-facility-asynchronous-service#analysis_region)
...
[number_of_facilities_to_find](/closest-facility-asynchronous-service#number_of_facilities_to_find)
...
[cutoff](/closest-facility-asynchronous-service#cutoff)
...
[travel_direction](/closest-facility-asynchronous-service#travel_direction)
...
[use_hierarchy](/closest-facility-asynchronous-service#use_hierarchy)
...
[time_of_day](/closest-facility-asynchronous-service#time_of_day)
...
[time_zone_for_time_of_day](/closest-facility-asynchronous-service#time_zone_for_time_of_day)
...
[time_of_day_usage](/closest-facility-asynchronous-service#time_of_day_usage)
...
[uturn_at_junctions](/closest-facility-asynchronous-service#uturn_at_junctions)
...
[point_barriers](/closest-facility-asynchronous-service#point_barriers)
...
-   [As a collection of features](/closest-facility-asynchronous-service#syntax-examples-for-point_barriers)
-   [As a feature service URL](/closest-facility-asynchronous-service#syntax-examples-for-point_barriers)
...
[line_barriers](/closest-facility-asynchronous-service#line_barriers)
...
-   [As a collection of features](/closest-facility-asynchronous-service#syntax-examples-for-line_barriers)
-   [As a feature service URL](/closest-facility-asynchronous-service#syntax-examples-for-line_barriers)
...
[polygon_barriers](/closest-facility-asynchronous-service#polygon_barriers)
...
-   [As a collection of features](/closest-facility-asynchronous-service#syntax-examples-for-polygon_barriers)
-   [As a feature service URL](/closest-facility-asynchronous-service#syntax-examples-for-polygon_barriers)
...
[restrictions](/closest-facility-asynchronous-service#restrictions)
...
Specifies which restrictions should be honored by the service. To learn about the accepted values for this parameter, see the [restrictions](/closest-facility-asynchronous-service#restrictions)  section below.
...
[attribute_parameter_values](/closest-facility-asynchronous-service#attribute_parameter_values)
...
Specifies additional values required by an attribute or restriction, such as whether the restriction prohibits, avoids, or prefers travel on restricted roads. To learn about the accepted values for this parameter, see the [attribute_parameter_values](/closest-facility-asynchronous-service#attributes-for-attribute_parameter_values)  section below.
...
[route_shape](/closest-facility-asynchronous-service#route_shape)
...
[route_line_simplification_tolerance](/closest-facility-asynchronous-service#route_line_simplification_tolerance)
...
[populate_directions](/closest-facility-asynchronous-service#populate_directions)
...
[directions_language](/closest-facility-asynchronous-service#directions_language)
...
Specifies the language that should be used when generating driving directions. This parameter applies only when the `populate_directions`  parameter is set to `true` . To learn about the accepted values for this parameter, see the [directions_language](/closest-facility-asynchronous-service#directions_language)  section below.
...
[directions_distance_units](/closest-facility-asynchronous-service#directions_distance_units)
...
[directions_style_name](/closest-facility-asynchronous-service#directions_style_name)
...
[impedance](/closest-facility-asynchronous-service#impedance)
...
[save_route_data](/closest-facility-asynchronous-service#save_route_data)
...
[save_output_network_analysis_layer](/closest-facility-asynchronous-service#save_output_network_analysis_layer)
...
[overrides](/closest-facility-asynchronous-service#overrides)
...
[time_impedance](/closest-facility-asynchronous-service#time_impedance)
...
[distance_impedance](/closest-facility-asynchronous-service#distance_impedance)
...
[output_format](/closest-facility-asynchronous-service#output_format)
...
[env:outSR](/closest-facility-asynchronous-service#envoutsr)
...
[ignore_invalid_locations](/closest-facility-asynchronous-service#ignore_invalid_locations)
...
[locate_settings](/closest-facility-asynchronous-service#locate_settings)
...
The service imposes a maximum limit of 5,000 points that can be passed as incidents. If the value is exceeded, the response returns an error message.
...
The following is the syntax for specifying incidents using a JSON structure for features:
...
The service imposes a maximum limit of 5,000 points that can be passed as facilities. If the value is exceeded, the response returns an error message.
...
The following is the syntax for specifying `facilities`  using a JSON structure for features:
...
The following is the syntax for specifying `facilities`  with custom attributes using a JSON structure for features:
...
The units of [cutoff](/closest-facility-asynchronous-service#cutoff)  parameter and the attribute values of `AdditionalTime` , `AdditionalDistance` , and `Cutoff`  on the [incidents](/closest-facility-asynchronous-service#incidents)  and [facilities](/closest-facility-asynchronous-service#facilities)  parameter are same as the units of the `measurement_units` .
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/FindClosestFacilities/jobs/<yourJobID>/cancel?token=<yourToken>&f=json` 
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/FindClosestFacilities/jobs/<yourJobID>/results/<output_parameter_name>?token=<yourToken>&f=json` 

Instead of retrieving outputs individually, you can make a request of the following form to retrieve all the outputs.

`https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/FindClosestFacilities/jobs/<yourJobID>/results?token=<yourToken>&f=json` 

Refer to the [Output parameters](/closest-facility-asynchronous-service#output-parameters) section for more information on how to interpret the solution provided by the service.
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/FindClosestFacilities/jobs/<yourJobID>/results/<output_parameter_name>?token=<yourToken>&f=json&outSR=102100` 
...
`https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/FindClosestFacilities/jobs/<yourJobID>/results?token=<yourToken>&f=json&outSR=102100` 

The below example shows how to retrieve the value for an input parameter by making the requests of the following form:

`https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/FindClosestFacilities/jobs/<yourJobID>/inputs/<inputParameterName>?token=<yourToken>&f=json` 


The below example shows how to retrieve all the inputs by making the request of the following form.

`https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/FindClosestFacilities/jobs/<yourJobID>/inputs?token=<yourToken>&f=json` 
...
The `ClosestFacilities`  output includes the `ORIG_FID`  field, and the `Facilities`  output includes the `FacilityOID`  field.
...
(If the straight-line distance between any facility and incident is greater than this limit, the analysis will fail when the walking option for `travel_mode`  is chosen.)
...
Maximum time a client can use the job request closest facility service
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/
FindClosestFacilities/submitJob?incidents={"features":[{"geometry":{"x":-122.449614,"y":37.746712},
"attributes":{"Name":"Fire Incident"}}]}
&facilities={"features":[{"geometry":{"x":-122.455962,"y":37.751316},
"attributes":{"Name":"Station 20"}},{"geometry":{"x":-122.440825,"y":37.753199},
"attributes":{"Name":"Station 24"}},{"geometry":{"x":-122.457844,"y":37.740713},
"attributes":{"Name":"Station 39"}}]}&travel_direction=Facility to Incident
&number_of_facilities_to_find=2&cutoff=3&time_of_day=1365637673000&time_of_day_usage=Start Time&
populate_directions=true&f=json&token=<yourToken>
```
...
```javascript
https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/
FindClosestFacilities/submitJob?incidents=%7B%22features%22:%5B%7B%22
geometry%22:%7B%22x%22:-122.449614,%22y%22:37.746712%7D,%22
attributes%22:%7B%22Name%22:%22Fire%20Incident%22%7D%7D%5D%7D&facilities=%7B%22features%22:%5B%7B%22
geometry%22:%7B%22x%22:-122.455962,%22y%22:37.751316%7D,%22
attributes%22:%7B%22Name%22:%22Station%2020%22%7D%7D,%7B%22geometry%22:%7B%22x%22:-122.440825,%22y%22:37.753199%7D,%22attributes%22:%7B%22Name%22:%22Station%2024%22%7D%7D,%7B%22geometry%22:%7B%22x%22:-122.457844,%22y%22:37.740713%7D,%22
attributes%22:%7B%22Name%22:%22Station%2039%22%7D%7D%5D%7D&travel_direction=Facility%20to%20Incident&number_of_facilities_to_find=2&cutoff=3&time_of_day=1365637673000&time_of_day_usage=Start%20Time
&populate_directions=true&f=json&token=<yourToken>
```
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/
FindClosestFacilities/jobs/<yourJobID>?returnMessages=true&f=json&token=<yourToken>
```
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/
FindClosestFacilities/jobs/<yourJobID>/results/output_closest_facilities?returnMessages=true&f=json&token=<yourToken>
```
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/
FindClosestFacilities/jobs/<yourJobID>/results/output_routes?returnMessages=true&f=json&token=<yourToken>
```
...
```other
https://logistics.arcgis.com/arcgis/rest/services/World/ClosestFacility/GPServer/
FindClosestFacilities/jobs/<yourJobID>/results/output_directions?returnMessages=true&f=json&token=<yourToken>
