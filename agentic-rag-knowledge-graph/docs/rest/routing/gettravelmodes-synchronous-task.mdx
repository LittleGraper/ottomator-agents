...
url: "/routing/gettravelmodes-synchronous-task"
...
migratedTopicMetadata:
  ...
  FCHANGES: "Change to routing services"
  FISHRELEASELABEL: ""
  FESRISOFTWARERELEASE: ""
  FESRITAGCLOUD: ""
  FESRIRECREATIONPROCEDURE: ""
  FESRIPRODUCTLIFECYCLE: "agol10.1.1-*"
  CREATED-ON: "25/04/2022 18:07:31"
  FAUTHOR: "pchopra"
  FSTATUS: "Released"
  ...
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "7"
  ED: "GUID-FD5B2609-4BA7-4CAE-B4FA-1B1AA4A65A82"
...
```other
https://route.arcgis.com/arcgis/rest/services/World/Utilities/GPServer/GetTravelModes/execute?f=pjson&token=<yourToken>
```
