---
title: "[itemID]: User Item (Link)"
description: "An individual user-uploaded item link resource returns alist of groups with which the item is shared."
slug: "user-item-link"
url: "/user-item-link"
guid: "GUID-DE5EAF89-5D5C-47AA-847B-FE59F0F72BD3"
migratedTopicMetadata:
  FTITLE: "User Item (Link)"
  FDESCRIPTION: ""
  FCHANGES: ""
  FISHRELEASELABEL: ""
  ...
  CREATED-ON: "18/10/2023 13:15:08"
  FAUTHOR: "svennapoosa"
  FSTATUS: "Draft"
  MODIFIED-ON: "19/10/2023 12:24:44"
  VERSION: "9"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "5"
  ED: "GUID-8F8E5D98-EBA0-44A5-A014-EB7EA7AEF47B"
  FUSERGROUP: "VUSERGROUPARCGISONLINEDOC"
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /content/users/[userName]/items/[itemID]
  urlSegments:
    - name: '[root]'
      url: /root
    - name: /content/users/[userName]/items/[itemID]
  methods: []
  sslOnly: 'no'
---
...
An individual user-uploaded item link resource returns alist of groups with which the item is shared. The item is not physically stored in the user's folder but is stored as a link to the original item in the [item resource](/item) (`/content/items/[itemId]`). Access to the item via this link is available only to the user.
...
<StyledTable headers={"Property,Details"}>
  ...
  <StyledTableRow>
    ...
    <StyledTableCell cellStyle="markdown">
      ...
      Epoch in milliseconds. Can be set for the [registered app](/registered-app) item. Used as expiration date when generating an API Token1.
  ...
  <StyledTableRow>
    ...
    <StyledTableCell cellStyle="markdown">
      ...
      Epoch in milliseconds. Can be set for the [registered app](/registered-app) item. Used as expiration date when generating an API Token2.
