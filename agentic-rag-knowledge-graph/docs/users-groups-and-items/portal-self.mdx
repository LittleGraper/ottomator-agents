---
title: "/self: Portal Self (Organization)"
description: "The self  resource returns the view of the portal as seen by the current user, whether anonymous or signed in."
slug: "portal-self"
url: "/portal-self"
guid: "GUID-E37E8F1E-D816-4C53-B447-4DC92FF02EE9"
migratedTopicMetadata:
  FTITLE: "Portal Self"
  FDESCRIPTION: ""
  FCHANGES: "Removing the conditions"
  FISHRELEASELABEL: ""
  FESRISOFTWARERELEASE: ""
  FESRITAGCLOUD: ""
  FESRIRECREATIONPROCEDURE: ""
  FESRIPRODUCTLIFECYCLE: "11.1- *"
  CREATED-ON: "17/04/2023 17:16:26"
  FAUTHOR: "tohara"
  FSTATUS: "Released"
  MODIFIED-ON: "18/04/2023 13:37:41"
  VERSION: "29"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "2"
  ED: "GUID-46E9939D-29AC-4FB3-A77B-397B9450EBAA"
  FUSERGROUP: "VUSERGROUPARCGISONLINEDOC"
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /portals/self
  urlSegments:
    - name: '[root]'
      url: /root
    - name: /portals/self
...
<StyledTable headers={"Property,Details"}>
  ...
  <StyledTableRow>
    ...
    <StyledTableCell cellStyle="markdown">
      ...
      This includes expiration date to help users know when the app expires. 
...
The [Generate Token](/generate-token) operation is the typical way of generating user tokens and was the only option before OAuth support. A `generateToken` token always represents a user and is never associated with an app. The Portal Self response for `generateToken` tokens includes the `user` property but does not include the `appInfo` property. 
