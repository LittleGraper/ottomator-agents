---
title: "[folderID]: Folder content"
description: "The user content resource returns information on the user's owned items within a folder."
slug: "folder"
url: "/folder"
restInfoMetadata:
  apiPath: /content/users/[username]/[folderID]
  urlSegments:
    - name: '[root]'
      url: /root
    - name: /content/users/[username]/[folderID]
  methods:
    - get
  sslOnly: 'no'
---
...
The following is a sample ArcGIS Online request URL used to access the user content resource within a folder:

```markdown
https://org.arcgis.com/sharing/rest/content/users/jsmith/1851c185888a43fcb3d6fffb78ae7c94?f=pjson
```

The following is a sample ArcGIS Enterprise request URL used to access the user content resource within a folder:

```markdown
https://machine.domain.com/webadaptor/sharing/rest/content/users/jsmith/1851c185888a43fcb3d6fffb78ae7c94?f=pjson
``` 

## Description

The user content resource returns information on the user's owned items within a folder. A user's content are items in a subfolder of the home folder with the given folder ID. Multilevel folders are not supported. Items in a folder are stored by reference and are not physically in a folder. Rather, they're stored as links to the [original item](/item) (e.g. `/content/items/<itemId>`).
...
<StyledTable headers={"Parameter,Details"}>
  ...
  <StyledTableRow>
    ...
    <StyledTableCell cellStyle="markdown">
      ...
      Sets the sort field for folder items. 
  ...
  <StyledTableRow>
    ...
    <StyledTableCell cellStyle="markdown">
      ...
      Sets sort order for folder items. 
