---
title: "/createWebhook: Create Webhook"
description: "The createWebhook operation allows portal administrators to create a new organization webhook."
slug: "create-webhooks"
url: "/create-webhooks"
guid: "GUID-67DE9DC9-3D71-4DE8-9DAB-D596019F76A6"
migratedTopicMetadata:
  FTITLE: "Create Webhooks"
  FDESCRIPTION: ""
  FCHANGES: "New triggers at 11.2"
  FISHRELEASELABEL: ""
  FESRISOFTWARERELEASE: ""
  FESRITAGCLOUD: ""
  FESRIRECREATIONPROCEDURE: ""
  FESRIPRODUCTLIFECYCLE: "11.2-*"
  CREATED-ON: "03/08/2023 11:44:30"
  FAUTHOR: "tohara"
  FSTATUS: "Released"
  MODIFIED-ON: "27/09/2023 08:47:11"
  VERSION: "9"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "3"
  ED: "GUID-E59CD823-C41A-43DD-B415-E0D280E4D6A9"
  FUSERGROUP: ""
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /portals/[portalID]/webhooks/createWebhook
  urlSegments:
    - name: '[root]'
      url: /root
    - name: /portals/[portalID]/webhooks/createWebhook
  methods:
    - post
  sslOnly: 'no'
...
<StyledTable headers={"Parameter,Details"}>
  ...
  <StyledTableRow>
    ...
    <StyledTableCell cellStyle="markdown">
      ...
      ```other
      url=https://app.logic.azure.com:443/workflows/dffb2e0433d245a3997e9d65a12f6ad2/triggers/manual/paths/invoke
      ```
  ...
  <StyledTableRow>
    ...
    <StyledTableCell cellStyle="markdown">
      ...
      This parameter is required if `changes` is specified as `manual`. The URI representation of an event that will trigger the webhook. For more information, see the [Supported trigger events](/create-webhooks#supported-trigger-events) section below. For additional examples of trigger events, see the [Trigger events](/create-webhooks#trigger-events) section below.
...
- [Items](/create-webhooks#items)
- [Groups](/create-webhooks#groups)
- [Users](/create-webhooks#users)
- [Roles](/create-webhooks#roles)
