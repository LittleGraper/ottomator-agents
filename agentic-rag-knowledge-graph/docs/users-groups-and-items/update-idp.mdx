---
title: "/[idpID]/update: Update IDP"
description: "The Update IDP operation (POST only) allows the organization administrator to edit the enterprise login configuration with a single IDP."
slug: "update-idp"
url: "/update-idp"
guid: "GUID-28BF9670-7EDF-4AC8-B8DA-F0A2CF870CBC"
migratedTopicMetadata:
  FTITLE: "Update IDP"
  FDESCRIPTION: "allows org admins to update enterprise login configuration setup using a single IDP"
  ...
  CREATED-ON: "08/03/2021 14:10:48"
  FAUTHOR: "tohara"
  FSTATUS: "Released"
  MODIFIED-ON: "25/08/2021 10:52:17"
  VERSION: "4"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "3"
  ED: "GUID-E294DA54-3472-443F-9427-9BFBB31C2486"
  FUSERGROUP: "VUSERGROUPARCGISONLINEDOC"
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /portals/[portalID]/idp/[idpID]/update
  urlSegments:
    - name: '[root]'
      url: /root
    - name: /portals/[portalID]/idp/[idpID]/update
  methods:
    - post
  sslOnly: 'no'
---
...
The following is a sample ArcGIS Online multipart POST request for the `update` operation:
...
The following is a sample ArcGIS Enterprise multipart POST request for the `update` operation:
...
The `update` operation allows the organization administrator to edit the enterprise login configuration with a single IDP.
