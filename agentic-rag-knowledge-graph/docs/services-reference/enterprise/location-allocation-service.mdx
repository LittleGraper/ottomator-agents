...
url: "/location-allocation-service"
guid: "GUID-951C09BD-BE55-4A61-BEBA-F6F7149585D5"
migratedTopicMetadata:
  FTITLE: "Location-Allocation service"
  FDESCRIPTION: ""
  FCHANGES: "Updating xrefs to direct link for migration to Gatsby"
  FISHRELEASELABEL: ""
  FESRISOFTWARERELEASE: ""
  FESRITAGCLOUD: ""
  FESRIRECREATIONPROCEDURE: ""
  FESRIPRODUCTLIFECYCLE: "11.3 - *"
  CREATED-ON: "17/12/2023 12:29:04"
  FAUTHOR: "pchopra"
  FSTATUS: "Draft"
  MODIFIED-ON: "17/12/2023 12:41:53"
  VERSION: "6"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "2"
  ED: "GUID-AFA45238-AC4D-47B2-AF64-B18B9856C543"
  FUSERGROUP: "VUSERGROUPARCGISONLINEDOC"
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /<serviceName>/GPServer/SolveLocationAllocation/submitJob
  urlSegments:
    - name: <root>
      url: /catalog
    - name: /<serviceName>/GPServer/SolveLocationAllocation/submitJob
  methods: 
   - get
   - post
  sslOnly: 'no'
...
-   [As a collection of features](/location-allocation-service#facilities)
-   [As a feature service URL](/location-allocation-service#facilities)
...
-   [As a collection of features](/location-allocation-service#point_barriers)
-   [As a feature service URL](/location-allocation-service#point_barriers)
...
-   [As a collection of features](/location-allocation-service#line_barriers)
-   [As a feature service URL](/location-allocation-service#line_barriers)
...
-   [As a collection of features](/closest-facility-async-services)
-   [As a feature service URL](/location-allocation-service#polygon_barriers)
...
Specify additional values required by an attribute or restriction, such as whether the restriction prohibits, avoids, or prefers travel on restricted roads. To learn about the accepted values for this parameter, see the [attribute_parameter_values](/location-allocation-service#attribute_parameter_values) section below.
...
[ignore_network_location_fields](/location-allocation-service#ignore_network_location_fields) 
...
[accumulate_attributes](/location-allocation-service#accumulate_attributes) 
...
-   `GroupName` 
    ...
    ![Minimizing distance without group names](./images/GUID-194E4F60-9830-40A2-89C3-4A8FD6C84301-web.png)

    _Minimize distance without grouped demand points._

    ![Minimizing distance with group names](./images/GUID-45B9C555-0591-4444-8AE6-BFC9BD4D4B6C-web.png)
...
![Minimize Impedance problem type](./images/GUID-E0E25028-3D18-4EBF-AFB6-6AD796AC4660-web.png)
...
![Maximize Coverage problem type](./images/GUID-8F8F6724-312E-44C4-BAFE-134FBF69B4DB-web.png)
...
![Maximize Capacitated Coverage problem type](./images/GUID-C89CBF41-76DC-4C0E-9F9D-D12E38B55591-web.png)
...
![Minimize Facilities problem type](./images/GUID-095ACCF2-CDF4-491A-8BE7-D2F619A104E1-web.png)
...
![Maximize Attendance problem type](./images/GUID-5D5FB2AE-5310-41A6-B2D5-E64B45D11E83-web.png)
...
![Maximize Market Share problem type](./images/GUID-1473BA06-4C46-4107-9D5D-48DE58125F28-web.png)
...
![Target Market Share problem type](./images/GUID-A88AFBCB-FA1D-4F9F-9E14-89AE91EEBFB6-web.png)
...
![Sample problem to demonstrate the effects of impedance transformations](./images/GUID-6FC3A804-CEA3-4914-99CB-BE03AA15F0FE-web.png)
...
![Sample problem to demonstrate the effects of impedance transformations](./images/GUID-793385B2-8A20-4BCA-8456-26F5C6F76163-web.png)
...
![Sample problem to demonstrate the effects of impedance transformations](./images/GUID-19F326AC-79AE-493C-987F-910F125968F9-web.png)
...
This example shows how to specify locate settings to prevent facilities and demand points from locating on highway ramps. The default locate settings allow locating on the Routing_Streets source. For facilities and demand points, the `overrides`  option is used to specify a where clause for the Routing_Streets source to prevent locating on highway ramps (a ROAD_CLASS field value of 3). With this `locate_settings`  json, facilities and demand points cannot locate on highway ramps, but barriers can because they use the default locate settings, which do not include a `where`  clause.
...
The maximum time an application can use the location-allocation service is 1 hour (3,600 seconds). If your request does not complete within this time limit, it will time out and fail.
...
```javascript
https:///SolveLocationAllocation/submitJob?parameters
```
...
```other
https:///SolveLocationAllocation/submitJob?facilities={"features":[{"attributes":{"OBJECTID":1,"Name":"Facility A","FacilityType":0,"CurbApproach":0},"geometry":{"x":-58.557329417999938,"y":-34.587693706999971}},{"attributes":{"OBJECTID":2,"Name":"Facility B","FacilityType":0,"CurbApproach":0},"geometry":{"x":-58.460247408999976,"y":-34.683348039999942}}]}& demand_points={"features":[{"attributes":{"OBJECTID":1,"Name":"Household 4","GroupName":"A","Weight":2,"CurbApproach":0},"geometry":{"x":-58.664405163999959,"y":-34.614819562999969}},{"attributes":{"OBJECTID":2,"Name":"Household 3","GroupName":"A","Weight":2,"CurbApproach":0},"geometry":{"x":-58.514499119999982,"y":-34.496322404999944}},{"attributes":{"OBJECTID":3,"Name":"Household 2","GroupName":null,"Weight":3,"CurbApproach":0},"geometry":{"x":-58.54162497599998,"y":-34.788996107999935}},{"attributes":{"OBJECTID":4,"Name":"Household 1","GroupName":null,"Weight":5,"CurbApproach":1},"geometry":{"x":-58.40599569799997,"y":-34.637662387999967}}]}&f=pjson&token=<yourToken>
```

 

```javascript
https:///SolveLocationAllocation/submitJob?facilities=%7B%22features%22:%5B%7B%22attributes%22:%7B%22OBJECTID%22:1,%22Name%22:%22Facility%20A%22,%22FacilityType%22:0,%22CurbApproach%22:0%7D,%22geometry%22:%7B%22x%22:-58.557329417999938,%22y%22:-34.587693706999971%7D%7D,%7B%22attributes%22:%7B%22OBJECTID%22:2,%22Name%22:%22Facility%20B%22,%22FacilityType%22:0,%22CurbApproach%22:0%7D,%22geometry%22:%7B%22x%22:-58.460247408999976,%22y%22:-34.683348039999942%7D%7D%5D%7D&demand_points=%7B%22features%22:%5B%7B%22attributes%22:%7B%22OBJECTID%22:1,%22Name%22:%22Household%204%22,%22GroupName%22:%22A%22,%22Weight%22:2,%22CurbApproach%22:0%7D,%22geometry%22:%7B%22x%22:-58.664405163999959,%22y%22:-34.614819562999969%7D%7D,%7B%22attributes%22:%7B%22OBJECTID%22:2,%22Name%22:%22Household%203%22,%22GroupName%22:%22A%22,%22Weight%22:2,%22CurbApproach%22:0%7D,%22geometry%22:%7B%22x%22:-58.514499119999982,%22y%22:-34.496322404999944%7D%7D,%7B%22attributes%22:%7B%22OBJECTID%22:3,
...
```other
https:///SolveLocationAllocation/jobs/<jobID>?returnMessages=true&f=pjson&token=<yourToken>
```
...
```other
https:///SolveLocationAllocation/jobs/<jobID>/results/output_facilities?f=pjson&token=<yourToken>
...
```other
https:///SolveLocationAllocation/jobs/<jobID>/results/output_demand_points?f=pjson&token=<yourToken>
```
...
```other
https:///SolveLocationAllocation/jobs/<jobID>/results/output_allocation_lines?f=pjson&token=<yourToken>
```
...
```javascript
https:///SolveLocationAllocation/jobs/<jobID>/cancel?token=<yourToken>&f=pjson
```
...
```javascript
https:///SolveLocationAllocation/jobs/<jobID>/inputs/<inputParameterName>?token=<yourToken>f=pjson
```
