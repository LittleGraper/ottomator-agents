...
description: "Learn how to use the fleet routing problem service."
slug: "vehicle-routing-problem-service-directrequest"
url: "/vehicle-routing-problem-service-directrequest"
guid: "GUID-D5BAEE94-7561-46A3-9F48-22EC46ED2DD4"
migratedTopicMetadata:
  FTITLE: "Vehicle Routing Problem service_DirectRequest"
  FDESCRIPTION: ""
  FCHANGES: "Fix the URL"
  FISHRELEASELABEL: ""
  FESRISOFTWARERELEASE: ""
  FESRITAGCLOUD: ""
  FESRIRECREATIONPROCEDURE: ""
  FESRIPRODUCTLIFECYCLE: "11.3 - *"
  CREATED-ON: "07/12/2023 10:59:41"
  FAUTHOR: "pchopra"
  FSTATUS: "To be reviewed"
  MODIFIED-ON: "12/12/2023 10:22:56"
  VERSION: "5"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "2"
  ED: "GUID-9952C022-6FDF-4BA5-B801-42C737938C3A"
  FUSERGROUP: "VUSERGROUPARCGISONLINEDOC"
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /<serviceName>/NAServer/<layerName>/EditVehicleRoutingProblem
  urlSegments:
    - name: <root>
      url: /catalog
    - name: /<serviceName>/NAServer/<layerName>/EditVehicleRoutingProblem
  methods:
   - get
   - post
  sslOnly: 'no'
...
[save_output_layer](/vehicle-routing-problem-service-directrequest#save_output_layer)
...
-   `CurbApproach` 
    ...
    When the vehicle approaches the depot, the depot can be on either side of the vehicle; however, when it departs, the vehicle must continue in the same direction it which it arrived. A U-turn is prohibited.
...
Example 1: Specify depots in the spatial reference of the network dataset using JSON structure. The example shows how to specify some attributes for the depots. 
...
Specify the parameter value as a numeric value representing the milliseconds since midnight, January 1, 1970.
...
Since the fleet routing service only supports time-based impedance, the values for the 
...
600 seconds for Direct request operation 

4 hours for Job request
