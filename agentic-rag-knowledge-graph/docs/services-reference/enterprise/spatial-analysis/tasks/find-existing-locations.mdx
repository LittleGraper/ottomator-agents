---
title: "Find Existing Locations"
description: "API reference for the Find Existing Locations task service available on ArcGIS Online."
slug: "find-existing-locations"
url: "/spatial-analysis/tasks/find-existing-locations"
redirectFrom:
  - /find-existing-locations
guid: "GUID-C13051B1-D422-458F-A012-C501E9255421"
migratedTopicMetadata:
  FTITLE: "Find Existing Locations"
  FDESCRIPTION: "REST API"
  FCHANGES: "update for 11.2 version strings"
  FISHRELEASELABEL: ""
  FESRISOFTWARERELEASE: ""
  FESRITAGCLOUD: ""
  FESRIRECREATIONPROCEDURE: ""
  FESRIPRODUCTLIFECYCLE: "agol23.R03-*:11.2-*"
  CREATED-ON: "10/08/2023 06:12:22"
  FAUTHOR: "sambrose"
  FSTATUS: "Released"
  MODIFIED-ON: "27/09/2023 04:56:36"
  VERSION: "8"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "7"
  ED: "GUID-8835285F-C2A0-4187-B6BB-54B19964ACD7"
...
![Find Existing Locations](../../images/GUID-FEF355B4-CF3B-48F6-9EC1-A00A1D53C81F-web.png)

The `FindExistingLocations` task selects features in the input layer that meet a specified query. A query is composed of one or more expressions. There are two types of expressions: attribute and spatial.
...
<StyledTable headers={"Parameter,Description"}>
   ...
   <StyledTableRow>
      ...
      <StyledTableCell cellStyle="markdown">
        ...
        [
         ...
         -   Date fields support all queries except `LIKE`. Dates are strings in `YYYY:MM:DD hh:mm:ss` format. The following is an example using the date field `ObsDate`:`"where": "ObsDate >=  '1998-04-30 13:30:00' "`
         ...
         <StyledTable headers={"spatialRel,Description"}>
            <StyledTableRow>
               ...
               <StyledTableCell cellStyle="markdown">
                  ![Intersects](../../images/GUID-90D4C386-63D7-48B1-A419-F766510B3D63-web.png)
            ...
            <StyledTableRow>
               ...
               <StyledTableCell cellStyle="markdown">
                  ![withinDistance](../../images/GUID-11976306-EACC-47ED-B379-0B6438374F94-web.png)
            ...
            <StyledTableRow>
               ...
               <StyledTableCell cellStyle="markdown">
                  ![contains](../../images/GUID-41677020-219D-49FA-9C19-0C9A54D63EF1-web.png)
            ...
            <StyledTableRow>
               ...
               <StyledTableCell cellStyle="markdown">
                  ![within](../../images/GUID-D790F35B-BBED-4896-8418-A4ACB2350575-web.png)
   ...
   <StyledTableRow>
      ...
      <StyledTableCell cellStyle="markdown">
         ...
         -   `True`—Only the portions of the feature that meet all criteria will be returned. Specifying this option, is equivalent to running the [`DeriveNewLocations`](/derive-new-locations) task.
