---
title: "Geocode Service"
description: "The GeocodeServer  resource represents a geocode (locator) service and provides basic information associated with the geocode service, such as the service description, address fields, spatial reference, and locator properties."
slug: "geocode-service"
url: "/geocode-service"
guid: "GUID-EFC2664E-83A7-4991-BAEA-2D95CF4D7C36"
migratedTopicMetadata:
  FTITLE: "Geocode Service"
  FDESCRIPTION: ""
  ...
  CREATED-ON: "14/08/2022 18:35:35"
  FAUTHOR: "tohara"
  FSTATUS: "Released"
  MODIFIED-ON: "15/08/2022 08:51:10"
  VERSION: "5"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "2"
  ED: "GUID-812D5842-B115-466D-AC8C-20A2BC03F0F2"
  FUSERGROUP: "VUSERGROUPARCGISONLINEDOC"
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /<serviceName>/GeocodeServer
  urlSegments:
    - name: <catalog-url>
      url: /catalog
    - name: /<serviceName>/GeocodeServer
  methods: []
  sslOnly: 'no'
...
Returns a list of candidates based on address and location.
...
Returns information about all the address fields pertaining to the reverse geocoded address as well as its exact location.
...
Returns a list of autocomplete suggestions for an input text string. Added at 10.3.
