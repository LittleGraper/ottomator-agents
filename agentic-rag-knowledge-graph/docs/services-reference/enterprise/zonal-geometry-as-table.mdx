---
title: "Zonal Geometry As Table"
description: "The ZonalGeometryAsTable task calculates the geometry measures for each zone in a dataset and reports the results as a table."
slug: "zonal-geometry-as-table"
url: "/zonal-geometry-as-table"
restInfoMetadata:
  apiPath: /<serviceName>/RasterAnalysisTools/GPServer/ZonalGeometryAsTable
  urlSegments:
    - name: <root>
      url: /catalog
    - name: /<serviceName>/RasterAnalysisTools/GPServer/ZonalGeometryAsTable
  methods: []
  sslOnly: 'no'
