---
title: "Clear Flags"
description: "The clearFlags operation clears any root junction, end junction, pivot junction and barrier flags in a diagram."
slug: "clear-flags-network-diagram-service"
url: "/clear-flags-network-diagram-service"
guid: "GUID-EE5EC924-96EB-4097-AE4C-43970E132C87"
migratedTopicMetadata:
  FTITLE: "Clear Flags (Network Diagram service)"
  FDESCRIPTION: ""
  FCHANGES: "license chagnes
released topic as changes are only to update conref."
  FISHRELEASELABEL: ""
  FESRISOFTWARERELEASE: ""
  FESRITAGCLOUD: ""
  FESRIRECREATIONPROCEDURE: ""
  FESRIPRODUCTLIFECYCLE: "10.8 - *"
  CREATED-ON: "24/09/2019 08:21:01"
  FAUTHOR: "ablin"
  FSTATUS: "Released"
  MODIFIED-ON: "24/09/2019 11:42:51"
  VERSION: "4"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "4"
  ED: "GUID-24761B6A-AE73-40A1-85BB-BF9C0EE45508"
  FUSERGROUP: ""
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /<serviceName>/NetworkDiagramServer/diagrams/<diagramName>/clearFlags
  urlSegments:
    - name: <root>
      url: /catalog
    - name: /<serviceName>/NetworkDiagramServer/diagrams/<diagramName>/clearFlags
  methods: 
    - post
  sslOnly: 'no'
...
The `clearFlags` operation clears any root junction, end junction, pivot junction and barrier flags in a diagram. It is performed on a [Diagram resource](/diagram-network-diagram-service). This operation returns the moment (date) the operation happens when it applies on a stored diagram. 
