---
title: "Set Cartographic Realignment Configuration"
description: "This operation sets the cartographic realignment configuration for the LRS dataset for the signed in ArcGIS Enterprise portal user."
slug: "lr-set-cartographic-realignment-configuration"
url: "/lr-set-cartographic-realignment-configuration"
guid: "GUID-D68BF265-17B8-47C2-9C52-4C01DCF79FD6"
migratedTopicMetadata:
  FTITLE: "LR Set Cartographic Realignment Configuration"
  FDESCRIPTION: ""
  FCHANGES: "New REST API endpoint (3774)"
  FISHRELEASELABEL: ""
  FESRISOFTWARERELEASE: ""
  FESRITAGCLOUD: ""
  FESRIRECREATIONPROCEDURE: ""
  FESRIPRODUCTLIFECYCLE: "10.9.1 - *"
  CREATED-ON: "22/09/2021 08:41:24"
  FAUTHOR: "jgardner"
  FSTATUS: "Released"
  MODIFIED-ON: "25/05/2023 11:00:27"
  VERSION: "1"
  FRESOLUTION: ""
  DOC-LANGUAGE: "en"
  FISHREVCOUNTER: "12"
  ED: "GUID-C8F4F262-7B4B-438F-A7A7-A6B8584D3A95"
  FUSERGROUP: ""
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /setCartoRealignConfiguration
  urlSegments:
    - name: <LinearReferencingService-url>
      url: /linear-referencing-service
    - name: /setCartoRealignConfiguration
  methods: []
  sslOnly: "no"
