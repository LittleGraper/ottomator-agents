...
slug: "compute-color-correction"
url: "/compute-color-correction"
...
migratedTopicMetadata:
  ...
  READ-ACCESS: ""
restInfoMetadata:
  apiPath: /System/OrthomappingTools/GPServer/ComputeColorCorrection
  urlSegments:
    - name: <root>
      url: /catalog
    - name: /System/OrthomappingTools/GPServer/ComputeColorCorrection
  methods: []
  sslOnly: 'no'
